...
const JWT_SECRET = new TextEncoder().encode('my-secret-key');
const ACCESS_TOKEN_EXPIRY = '3s';
const REFRESH_TOKEN_EXPIRY = '7d';

export function createRefreshTokenCookie(refresToken: string) {
  return `refreshToken=${refresToken}; Max-Age=604800`;
}
